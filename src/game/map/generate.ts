import type { GameMap, Tile, Terrain, MapObject, Coord, Faction, Resource } from '../types';
import { mulberry32, randInt, randChoice, shuffle } from '../utils/rng';
...
const TERRAIN_COSTS: Partial<Record<Terrain, number>> = {
  grass: 100, dirt: 100, sand: 150, rough: 125, snow: 150,
};
...
const MINE_ICONS: Record<Resource, string> = {
  gold: '🏦', wood: '🪚', ore: '⛏️', mercury: '⚗️', sulfur: '🌋', crystal: '🔮', gems: '💠',
};
